...
const WeatherDetails = ({ details }: { details: WeatherDetailsProps }) => {
  return (
    <div className='flex flex-col items-center sm:items-start p-8 sm:p-4 justify-center sm:bg-black sm:bg-opacity-10 sm:rounded-r-full sm:shadow-lg sm:w-1/2 h-52 sm:pl-8'>
